...
const data = {
  ...
  products: [
    ...
    {
      name: 'Samstongue 49-Inch CHG90 144Hz Curved Gaming Monitor (LC49HG90DMNXZA) – Super Ultrawide Screen QLED',
      price: 999.99,
      description:
    ...
    {
      name: 'Camo Green Pants - Made by Laufer',
      price: 19.54,
    ...
    {
      name: "Men's Arrow Necklace Gold",
      price: 299.99,
    ...
    {
      name: 'Danseuse Étoile Choker Gold-finish metal | DIOR',
      price: 55.55,
      description:
    ...
    {
      name: 'Clever Headphones | iClever',
      price: 36.99,
      description:
    ...
    {
      name: 'Designer Pants for Women - FARFETCH',
      price: 14.99,
      description:
